...
export default function Ex4() {
  return (
    <div className="my-8">
      ...
      <div className="min-w-[24rem] max-w-screen bg-blue-400 p-5 flex-row">
        <h1 className="font-bold">Título do card!</h1>
        <p className="">lorem ipsum sit dolor amet</p>
        <button className="p-1 border-1 rounded-xl mt-3 hover:bg-blue-300 transition-colors duration-300">Clique aqui!</button>
      </div>
      </div>
    </div>
  );
